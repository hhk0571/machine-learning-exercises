...
I = eye(num_labels);
y = I(y,:); % transform as row vector 5000 * 10
...
%% first column of Theta doesn't need regularization, they are for bias term
Theta1_grad(:,2:end) = Theta1_grad(:,2:end) + ((lambda / m) * Theta1(:,2:end));
Theta2_grad(:,2:end) = Theta2_grad(:,2:end) + ((lambda / m) * Theta2(:,2:end));

%% Another way to compute the theta gradient:
